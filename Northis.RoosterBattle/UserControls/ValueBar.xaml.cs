...
namespace Northis.RoosterBattle.UserControls
{
	/// <summary>
	...
	public partial class ValueBar : UserControl
	{
		...
		public static readonly DependencyProperty LevelProperty =
			DependencyProperty.Register(nameof(ValueLevel), typeof(double), typeof(ValueBar), new FrameworkPropertyMetadata(0.0, FrameworkPropertyMetadataOptions.BindsTwoWayByDefault, OnValueLevelChanged));

		public static readonly DependencyProperty TextSizeProperty =
			DependencyProperty.Register(nameof(TextSize), typeof(double), typeof(ValueBar), new FrameworkPropertyMetadata(16.0, FrameworkPropertyMetadataOptions.BindsTwoWayByDefault, OnTextSizeChanged));

		public static readonly DependencyProperty ValueColorProperty =
			DependencyProperty.Register(nameof(ValueColor), typeof(Brush), typeof(ValueBar), new FrameworkPropertyMetadata(Brushes.DarkRed, FrameworkPropertyMetadataOptions.BindsTwoWayByDefault, OnValueColorChanged));

		public static readonly DependencyProperty MaxValueProperty =
			DependencyProperty.Register(nameof(MaxValue), typeof(int), typeof(ValueBar), new FrameworkPropertyMetadata(100, FrameworkPropertyMetadataOptions.BindsTwoWayByDefault, OnMaxValueChanged));
		#endregion
		...
		private static void OnValueLevelChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
		{
			...
			obj.Value.Text = Math.Round((double) e.NewValue).ToString(CultureInfo.CurrentCulture);
		}
